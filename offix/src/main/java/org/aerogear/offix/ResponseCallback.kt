...
interface ResponseCallback {
    ...
    /*
     ...
     @return type: ArrayList<Mutation<Operation.Data,Any,Operation.Variables>>?
     */
    fun onConflictDetected(serverClientStates: ArrayList<ServerClientData>): ArrayList<Mutation<Operation.Data,Any,Operation.Variables>>?
}